...
class Person {
  ...
  Person({required this.uid, required this.username, required this.selectedPosts, this.email, required this.colorCode1, required this.colorCode2});
  ...
  Person copyWith({String? uid, String? username, List<String>? selectedPosts, ValueGetter<String?>? email, int? colorCode1, int? colorCode2}) {
    return Person(
      uid: uid ?? this.uid,
  ...
  Map<String, dynamic> toMap() {
    return {'uid': uid, 'username': username, 'selectedPosts': selectedPosts, 'email': email, 'colorCode1': colorCode1, 'colorCode2': colorCode2};
  }
